...
export function App() {
  ...
  return (
    <TodoContextProvider value={{ todos, addTodo, deleteTodo, editTodo, isDoneTodo }}>
      <div className='flex gap-8 justify-center sm:w-full items-start mt-4 w-full flex-col min-h-screen bg-cover' style={{ backgroundImage: `url(https://res.cloudinary.com/dpqdgcipi/image/upload/v1718641814/3d-rendering-blue-pen-with-paper_pedazy.jpg)` }}>
        <Title />
        <InputBox />
        {todos.map((el) => (<div>
          <TodoList todo={el} />
